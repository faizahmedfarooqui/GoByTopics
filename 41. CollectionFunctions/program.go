 ...
 *
 * In some languages it’s idiomatic to use generic data structures &
 ...
 * use these examples to build your own functions. Note that in some cases
...
// Include : return true if the target strnig t is in the slice
func Include(vs []string, t string) bool {
	return Index(vs, t) >= 0
}

// Any : return true if one of the strings in the slice satisfies
// the predicate f
...
// Filter : returns a new slice containing all the strings in

...
func main() {
	...
	// arrays. One is the builtin append, which returns
	// a slice containing one or more new values. Note
	// that we need to accept a return value from append
	...
	// syntax slice[low:high]. For example, this gets
	// a slice of the elements s[2], s[3], and s[4].
	...
	// slice in a single line as well.
